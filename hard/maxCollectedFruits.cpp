...
int main() {
    Solution sol;
    vector<vector<int>> fruits1 = {{1, 2, 3, 4}, {5, 6, 8, 7}, {9, 10, 11, 12}, {13, 14, 15, 16}};
    cout << sol.maxCollectedFruits(fruits1) << endl; // Output: 100

    vector<vector<int>> fruits2 = {{1, 1}, {1, 1}};
    cout << sol.maxCollectedFruits(fruits2) << endl; // Output: 4
